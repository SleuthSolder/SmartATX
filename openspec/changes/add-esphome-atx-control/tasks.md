...
- [x] 1.1 Confirm the board from the silkscreen and record it
...
- [ ] 3.1 Flash over USB and confirm the device appears in Home Assistant
      (flashed and on the network, API port open, diagnostics
...
- [x] 4.9 Write the toolchain setup guide with real command transcripts (published on the website)
...
- [x] 4.11 Write the GUI flashing walkthrough (published on the website)

## 5. Close out
- [ ] 5.1 Cross-check the finished config and docs against the article plan
